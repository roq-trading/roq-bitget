# [roq-bitget](https://roq-trading.com/docs/reference/gateways/crypto/roq-bitget/)

Roq's Bitget gateway.
...
Reference documentation can be found [here](https://roq-trading.com/docs/reference/gateways/crypto/roq-bitget/).
