...
:code:`roq-bitget-futures`
--------------------------

.. code-block:: shell

   $ roq-bitget-futures [FLAGS]


Description
~~~~~~~~~~~

:code:`roq-bitget-futures` is a gateway
...
.. tab:: Prod
   ...
   .. code-block:: shell
      ...
      $ $CONDA_PREFIX/share/roq-bitget-futures/flags/prod/flags.cfg
...
.. code-block:: shell
   ...
   $ $CONDA_PREFIX/share/roq-bitget-futures/config.toml
