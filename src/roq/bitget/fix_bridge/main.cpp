...
#include "roq/bitget/fix_bridge/application.hpp"
...
auto const INFO = roq::Service::Info{
    .description = "Roq's Bitget gateway (FIX interface)"sv,
...
int main(int argc, char **argv) {
  ...
  return roq::bitget::fix_bridge::Application{args, settings, INFO}.run();
}
